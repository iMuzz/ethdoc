            ...
            <div className="row center">
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 intro">
                ...
                <div className="block-rtl demo">
                  <a
                    href="https://twitter.com/FaraazNishtar/status/994271380261584897"
                    target="_blank"
                  >
              ...
              <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div className="step-content right">
                  ...
                  <p className="step-text">
                    Use{' '}
                    <a
                      href="https://github.com/ethereum/wiki/wiki/Ethereum-Natural-Specification-Format"
                      target="_blank"
                    >
                      Ethereum Natural Specification
                    </a>{' '}
                    format to write inline comments in your Solidity files.
                  </p>
                </div>
              </div>
            </div>
