const generateCodeSample = ({ contractName, contractAddress='0x5049152044B3b4dAbA58479B6fF54346f8e60EAe', method }) => {
...
codeSample += `
${contractName}Instance.methods.${methodName}(${findArguments(method.inputs)}).call().then((res) => {
  console.log(res);
});
`;
